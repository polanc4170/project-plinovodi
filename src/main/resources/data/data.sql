...
INSERT INTO user_report (primary_key, id, first_name, last_name, date_start) VALUES
(1, 1, 'Janez', 'Novak', '2024-02-05'),
(2, 2, 'Peter', 'Svete', '2024-02-12'),
(3, 3, 'Mirko', 'Petek', '2024-02-19');

INSERT INTO user_intervention (primary_key, id, date_start, hour_start, hour_end, desc_short, desc_long) VALUES
...
INSERT INTO user_interventions (id_report, id_intervention) VALUES
(1, 1),
(1, 2),
(1, 3),
(2, 4);
